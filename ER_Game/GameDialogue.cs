...
namespace ER_GameLibrary
{
    public class GameDialogue
    {
        ...
        public void Chapter1()
        {
            ...
            SetCursorPosition(7, 8); ForegroundColor = ConsoleColor.White; PrintbyChar("Ocil: Yea, I dont see what you're getting at though?");
            SetCursorPosition(7, 9); ForegroundColor = ConsoleColor.DarkRed; PrintbyChar("Thruul: Stupid, let's just take the ride and sell it. Its gotta be worth at least 100K krubels.");
            ...
            SetCursorPosition(7, 11); ForegroundColor = ConsoleColor.White; PrintbyChar("Ocil: Drop me off at the nearest planet, just in case she tries to follow or give us any problems I can take her out.");
            ...
            SetCursorPosition(7, 22); ForegroundColor = ConsoleColor.DarkGreen; PrintbyChar("Upon landing on planet Kir, she finds Ocil waiting for her.");
            SetCursorPosition(7, 23); ForegroundColor = ConsoleColor.DarkCyan; PrintbyChar("Elta: WHERE IS MY IRNO!!!!!");
            SetCursorPosition(7, 24); ForegroundColor = ConsoleColor.White; PrintbyChar("Ocil: Wooah Woah Woah little lady, what do you think you're gonna do huh? You gonna cry buahah!");
      ...
      //public void ScreenDirections() ****not necessary****
      //  {
      //      Clear();
      ...
      //  }
        ...
        public void Chapter2()
        {
            ...
            SetCursorPosition(7, 11); ForegroundColor = ConsoleColor.DarkGreen; PrintbyChar("Elta finds Thruul with another mobster named Yilkir.");  //Elta finds Thruul
            ...
            SetCursorPosition(7, 17); ForegroundColor = ConsoleColor.DarkCyan; PrintbyChar("Elta: Dont worry about it! I just want my dog!");
           ReadKey();
            Clear();
        }
        public void Chapter2End()
        {
            ...
            SetCursorPosition(7, 18); ForegroundColor = ConsoleColor.DarkGreen; PrintbyChar("After beating Thruul, Elta stares down at him disgustedly.");
            ...
            SetCursorPosition(7, 19); ForegroundColor = ConsoleColor.DarkCyan; PrintbyChar("Elta: I know where Irno is so really there's no need for you huh?");
        ...
        public void Chapter3()
        {
            ...
            SetCursorPosition(7, 6); ForegroundColor = ConsoleColor.DarkBlue; PrintbyChar("Yilkir: Man where in the world is Ocil and Thruul? ");
            ...
            SetCursorPosition(7, 11); ForegroundColor = ConsoleColor.Magenta; PrintbyChar("Yilkir: Yo Tanqin, take the dog and get out of here. I'll handle the human.");
            SetCursorPosition(7, 12); ForegroundColor = ConsoleColor.DarkGreen; PrintbyChar("As Yilkir gets ready for battle, Elta walks into the room.");
            ...
            SetCursorPosition(7, 14); ForegroundColor = ConsoleColor.Magenta; PrintbyChar("Yilkir: Listen here little lady, I'm one of the highest ranking in the Audinian Mob, if you wanna fight, then let's go trash");
        ...
        public void Chapter3End()
        {
            ...
            SetCursorPosition(7, 14); ForegroundColor = ConsoleColor.DarkYellow; PrintbyChar("Bhailmaith: A good death is its own reward! ");
        ...
        public void Chap4Dialouge()
        {
            ...
            SetCursorPosition(7, 7); ForegroundColor = ConsoleColor.DarkYellow; PrintbyChar("Bhailmaith: YOU STUPID RHINOCEROS PIZZLE, WHAT IS GOING ON?! WHO IS THIS ON YILKIRS PHONE");
